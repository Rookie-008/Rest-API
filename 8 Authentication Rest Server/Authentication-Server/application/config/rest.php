...
|
*/
// $config['rest_valid_logins'] = ['admin' => 'rxz3569', 'user' => 'xbl9325'];
$config['rest_valid_logins'] = ['admin' => '1234', 'user' => 'abc5735'];
...
// $config['rest_key_name'] = 'USER-API-KEY';
// $config['rest_key_name'] = 'SECRET-API-KEY';
$config['rest_key_name'] = 'NEW-API-KEY';
